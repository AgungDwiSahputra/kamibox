<ul class="list_riwayat">
    ...
    /* Riwayat Transaksi */
    $query_transaksi = mysqli_query($conn, "SELECT * FROM transaksi_pembelian INNER JOIN users ON users.id_user = transaksi_pembelian.pemasok_id WHERE no_invoice LIKE '$search_keyword' OR nama_lengkap LIKE '$search_keyword' OR pemasok_id LIKE '$search_keyword' OR tgl_transaksi LIKE '$search_keyword'");
