            ...
            <form action="#" id="form-edit">
                ...
                <div style="background: #fff;padding: 20px;">
                    <div style="padding-bottom:15px;">
                        ...
                        <input type="number" min="0" name="kd_barang" id="kd_barang">
                        <p style="margin: unset;font-size: small;font-style: italic;color: #ff1b6c;font-weight: 100;" class="text-kd_barang"></p>
                    </div>
                    <div style="padding-bottom:15px;">
                    ...
                    <div style="padding-bottom:15px;" hidden>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.sukses) {
                        ...
                        $('#kd_barang').val(response.sukses.kd_barang)
                ...
                success: function(response) {
                    if (response.sukses) {
                        ...
                        if (response.error.nama) {
                            $('#kd_barang').addClass('invalid')
                            $('.text-kd_barang').html(response.error.kd_barang)
                        } else {
                            $('#kd_barang').removeClass('invalid')
                            $('.text-kd_barang').html('')
                        }
